...
function ProjectDisplay() {
    ...
    const projects = [['Algorithms in Action', 'A website that visualizes different computer algorithms for students to understand them better and educators to better deliver their lessons', 'Tech: Javascript, CSS, HTML'], ['BioNix', 'Wrapping bioinformatics software into a package manager called BioNix', 'Tech: Nix, Markdown'], ['Life-saving Mask', 'An ECommerce Site that focuses on the marketing of Life-Saving mask products', 'Tech: ReactJS, TailwindCSS, HTML'], ['Unrefusable Valentine', 'An ultimate web app designed to ask someone to be your Valentine in a way that is impossible to say no', 'Tech: ReactJS, TailwindCSS, HTML'], ['Portfolio', 'My digital portofio to showcase my experiences, projects, contacts and most importantly, my UI design and development capabilities', 'Tech: ReactJS, HTML, CSS'], ['Kamo', 'An AI Chatbot that assists students with subjects information of multiple universities, and course optimization', 'Tech: VueJS, CSS, HTML, .Net Core, MySQL'], ['Data Processing Portal', 'A website that receives a list of product information page URLs of any eCommerce websites in Australia, and a custom prompt denoting the curation of data, scrapes the data and returns downloadable CSV or Excel files with the curated data', 'Tech: ReactJS, Express, TailwindCSS, OpenAI API']] 
    const githubUrls = ['https://github.com/tuankhainguy/algorithms-in-action.github.io', 'https://github.com/WEHI-ResearchComputing/BioNix-GettingStarted/wiki', 'https://github.com/nicked1205/Mask-Ecommerce-Site', 'https://github.com/nicked1205/Unrefusable-Valentine', 'https://github.com/nicked1205/Portfolio', '', 'https://github.com/nicked1205/Data-Processing-Portal']
    const webUrls = ['https://dev-aia.vercel.app/', '', 'https://www.khautrangtaooxy.vn/', 'https://valentine-delta-livid.vercel.app/', 'https://www.nickng.me/', '', 'https://data-processing-portal-blush.vercel.app/']
    const imageUrls = [AIA, BioNix, Mask, UnrefusableValentine, Portfolio, Kamo, DataProcessingPortal]
